...
int main(int argc, char const *argv[]){
  ...
  /* Generate Workload for fixed_length key or variable_length key*/
    Allocator::ZAllocate((void **)&workload, kCacheLineSize, sizeof(uint64_t) * (insert_num + 100) * 2);
    int i;
    ...
    std::cout << "Insertion throughput: " << insert_num / time_spent << " ops/s" << std::endl;
    ...
    std::cout << "Postive search throughput: " << insert_num / time_spent << " ops/s" << std::endl;
    ...
    time_spent = (double)(end - begin) / CLOCKS_PER_SEC;
    std::cout << "Not found = " << not_found << std::endl;
    std::cout << "Negative search throughput: " << insert_num / time_spent << " ops/s" << std::endl;
    ...
    time_spent = (double)(end - begin) / CLOCKS_PER_SEC;
    std::cout << "Not found = " << not_found << std::endl;
    std::cout << "Delete throughput: " << insert_num / time_spent << " ops/s" << std::endl;
